                                ...
                                if base_Category.lower() == "gm":
                                    ...
                                    if float(base_Sale_Price1) > 0 and int(sale_start1) > '1900-01-01 00:00:00':
                                        ...
                                        if s_stamp >= datetime.datetime(sale_start1) and s_stamp <= datetime.datetime(sale_end1):
                                            ...
                                            if use_api:
                                                api_responses, json_outstring, soap_update_str, api_req_counter, api_out_page_count, command_id, page_line_count, api_out_line_count = send_api(use_soap, json_outstring, api_responses, page_line_count, api_out_page_count, patch_header, rest_api_url, soap_update_str, api_req_counter, command_id, api_out_line_count, itemid, regular_price, ITEMIPF, target_delay, base_FormatFlag, base_Author, base_Title, base_ISBN, base_Used_ISBN, base_ISBN_HR, base_Vendor_Style, base_Publisher, base_Imprint, base_Edition, base_Edition_Status, base_New_Price, base_New_Price_Text, base_Used_Price, base_Used_Price_Text, base_New_Rental_Price, base_New_Rental_Price_Text, base_Ebook_Price, base_Ebook_Price_Text, base_Used_Rental_Price, base_Used_Rental_Price_Text, base_Sale_Price, target_date_start, target_date_end, base_Sale_Price1, base_Sale_Start_Date1, base_Sale_End_Date1, base_Sale_Start_Time1, base_Sale_End_Time1,
...
def send_api(use_soap, json_outstring, api_responses, page_line_count, api_out_page_count, patch_header, rest_api_url, soap_update_str, api_req_counter, command_id, api_out_line_count, itemid, regular_price, ITEMIPF, target_delay, base_FormatFlag, base_Author, base_Title, base_ISBN, base_Used_ISBN, base_ISBN_HR, base_Vendor_Style, base_Publisher, base_Imprint, base_Edition, base_Edition_Status, base_New_Price, base_New_Price_Text, base_Used_Price, base_Used_Price_Text, base_New_Rental_Price, base_New_Rental_Price_Text, base_Ebook_Price, base_Ebook_Price_Text, base_Used_Rental_Price, base_Used_Rental_Price_Text, base_Sale_Price, target_date_start, target_date_end, base_Sale_Price1, base_Sale_Start_Date1, base_Sale_End_Date1, base_Sale_Start_Time1, base_Sale_End_Time1, base_Sale_Price2, base_Sale_Start_Date2, base_Sale_End_Date2, base_Sale_Start_Time2, base_Sale_End_Time2, base_Sale_Price3, base_Sale_Start_Date3, base_Sale_End_Date3, base_Sale_Start_Time3,
